...
export default function OnboardingTableRow() {
  ...
  return (
    ...
    <td className="text-left flex py-2 pl-2 pr-8 gap-x-2 flex-wrap w-[297px]">
      <button onClick={handleViewClick} className="w-[80px] text-black text-sm font-semibold bg-[#d9d9d9] py-2 px-3 rounded-full transition duration-200 hover:bg-gray-200 active:bg-gray-400">
        View
      </button>
    ...
    <OnboardingMemberModal isModalOpen={isModalOpen} handleCloseModal={handleCloseModal} />
    </>
  )
}