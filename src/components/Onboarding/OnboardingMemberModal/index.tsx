  ...
  return (
    <ModalLayout isOpen={isModalOpen} onClose={handleCloseModal}>
        ...
        <div className="flex items-center justify-between border border-gray-700 py-3 px-4 rounded-md mb-2">
            <p>
              <span className="font-semibold">Email:</span> tharshensurianbalan@gmail.com
            </p>
            <Copy onClick={() => copyToClipBoard()} className="hover:text-gray-400 active:text-green-500" size="16"/>
        </div>
        ...
        <div className="flex flex-col gap-x-2 border border-gray-700 py-3 px-4 rounded-md max-h-36 lg:max-h-48 overflow-y-auto">
            <p><span className="font-semibold">Active:</span> </p>

            <p><span className="font-semibold">Register Date:</span> </p>

            <p><span className="font-semibold">Comment:</span> </p>
        </div>
        <button
